  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        glass: "glass text-foreground shadow-sm hover:bg-white/40 dark:hover:bg-gray-900/40",
        gold: "bg-luxury-gold text-luxury-dark shadow-sm hover:bg-luxury-gold/90",
        emerald: "bg-emerald-700 text-white shadow-sm hover:bg-emerald-800",
        teal: "bg-teal-700 text-white shadow-sm hover:bg-teal-800",
        luxury: "bg-luxury-dark border border-luxury-gold/50 text-luxury-gold hover:bg-luxury-gold/10",
      },
      size: {
